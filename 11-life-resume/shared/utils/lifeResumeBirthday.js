...
export function getBirthYearMax(now = new Date()) {
 ...
 */
export function validateBirthDate(input, now = new Date()) {
...
export function formatBirthDateLabel({ birthYear, birthMonth, birthDay } = {}) {
...
export function toPublicBirthday(row = {}) {
