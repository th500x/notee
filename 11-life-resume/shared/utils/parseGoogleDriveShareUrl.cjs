 ...
 * 须与 parseGoogleDriveShareUrl.js 同步
 */

const GOOGLE_DRIVE_ALLOWED_HOSTS = [
  'drive.google.com',
  'docs.google.com',
  'sheets.google.com',
  'slides.google.com',
...
function parseGoogleDriveShareUrl(raw) {
...
function buildGoogleDrivePreviewUrl(resourceKind, resourceId) {
...
function formatGoogleDriveFromRow(row) {
...
function normalizeGoogleDriveDisplayLabel(displayLabel) {
