...
export const S1_FACTIONS = [
  // ==================== 1. 刘备势力 ====================
  {
    ...
    // 势力关系
    relations: {
      allies: ['faction_1601'],      // 汉室（盟友）
      neutral: ['faction_1301', 'faction_1201'],  // 孙坚、曹操（中立�?
      enemies: ['faction_1501', 'faction_1701'],  // 董卓、黄巾（敌对�?
    },
  ...
  // ==================== 2. 孙坚势力 ====================
  {
    ...
    relations: {
      allies: ['faction_1601'],      // 汉室（盟友）
      neutral: ['faction_1101', 'faction_1201', 'faction_1401'],  // 刘备、曹操、袁绍（中立�?
      enemies: ['faction_1501', 'faction_1701'],  // 董卓、黄巾（敌对�?
    },
  ...
  // ==================== 3. 曹操势力 ====================
  {
    ...
    relations: {
      allies: ['faction_1601'],      // 汉室（盟友）
      neutral: ['faction_1101', 'faction_1301', 'faction_1401'],  // 刘备、孙坚、袁绍（中立�?
      enemies: ['faction_1501', 'faction_1701'],  // 董卓、黄巾（敌对�?
    },
  ...
  // ==================== 4. 汉室势力 ====================
  {
    ...
    relations: {
      allies: ['faction_1101', 'faction_1301', 'faction_1201', 'faction_1401'],  // 刘备、孙坚、曹操、袁绍（盟友�?
      neutral: [],
      enemies: ['faction_1501', 'faction_1701'],  // 董卓、黄巾（敌对�?
    },
  ...
  // ==================== 5. 董卓势力 ====================
  {
    ...
    relations: {
      allies: [],
      neutral: [],
      enemies: ['faction_1101', 'faction_1301', 'faction_1201', 'faction_1601', 'faction_1401'],  // 所有势力（敌对�?
    },
  ...
  // ==================== 6. 袁绍势力 ====================
  {
    ...
    relations: {
      allies: ['faction_1601'],      // 汉室（盟友）
      neutral: ['faction_1101', 'faction_1301', 'faction_1201'],  // 刘备、孙坚、曹操（中立�?
      enemies: ['faction_1501', 'faction_1701'],  // 董卓、黄巾（敌对�?
    },
  ...
  // ==================== 7. 黄巾势力 ====================
  {
    ...
    relations: {
      allies: [],
      neutral: [],
      enemies: ['faction_1101', 'faction_1301', 'faction_1201', 'faction_1601', 'faction_1501', 'faction_1401'],  // 所有势力（敌对�?
    },
