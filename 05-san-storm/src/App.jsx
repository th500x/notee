      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg shadow-md p-6 border-2 border-purple-200">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-gray-900 mb-2">项目追踪</h3>
          ...
          <div className="hidden md:block text-right">
            <div className="text-sm text-gray-500 mb-1">当前周</div>
            <div className="text-2xl font-bold text-purple-600">W07</div>
            <div className="text-xs text-gray-500 mt-1">2月16日-2月22日</div>
          </div>
        </div>
      </div>
