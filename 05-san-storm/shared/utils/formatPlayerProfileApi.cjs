...
function formatPlayerPositionConfigForApi(positionConfig) {
...
function formatPlayerForProfileApi(player, extras = {}) {
...
function formatPlayerCardForProfileApi(card) {
...
function formatPlayerProfilePayloadForApi(payload) {
...
module.exports = {
  formatPlayerPositionConfigForApi,
  formatPlayerForProfileApi,
  formatPlayerCardForProfileApi,
  formatPlayerProfilePayloadForApi,
};
