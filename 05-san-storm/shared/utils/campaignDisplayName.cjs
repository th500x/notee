...
function parseCampaignFactionIds(factionStr) {
...
function resolveCampaignFactionDisplayLabel(factionStr) {
...
function formatCampaignDisplayName(campaign) {
...
function formatCampaignCenterSelectOptionLabel(campaign) {
...
module.exports = {
  parseCampaignFactionIds,
  resolveCampaignFactionDisplayLabel,
  formatCampaignDisplayName,
  formatCampaignCenterSelectOptionLabel,
  GENERAL_CAMPAIGN_FACTION_LABEL,
};
