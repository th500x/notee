 ...
 */
function buildCellsFromMeowaMap(meowaMap, size) {
 ...
 */
function applyCityFootprints(cells, cities) {
 ...
 */
function applyBattlefieldEntries(cells, battlefield) {
 ...
 */
function applyBattlefieldInfoRect(cells, battlefield) {
 ...
 */
function resolveRoadLayer(previousMerged, size) {
 ...
 */
function buildJunMergedFromMeowa(opts) {
...
module.exports = {
  WATER_TILESET_IDS,
  resolveMeowaStampGrid,
  buildCellsFromMeowaMap,
  applyCityFootprints,
  applyBattlefieldEntries,
  applyBattlefieldInfoRect,
  resolveRoadLayer,
  buildJunMergedFromMeowa,
};
