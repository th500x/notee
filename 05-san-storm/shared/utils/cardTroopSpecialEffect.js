 ...
 * 须与 cardTroopSpecialEffect.cjs 同步
 *
...
export const CARD_TROOP_SPECIAL_EFFECT_KEYS = {
...
export const CARD_TROOP_EFFECT_CONFIG_TABLES = {
...
export const CARD_TROOP_EFFECT_CARD_TYPES = ['title', 'achievement', 'treasure'];

/**
 * @param {string|null|undefined} effectStr
 * @returns {Record<string, number>}
 */
export function parseCardTroopSpecialEffect(effectStr) {
  if (!effectStr) return {};
  const bonus = {};
...
export function parseCardTroopSpecialEffectFromConfigValue(rawValue) {
 ...
 * @param {string} cardId
 */
export async function loadCardTroopSpecialEffectBonus(conn, cardType, cardId) {
