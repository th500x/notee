...
const MESSAGES = {
  zh: {
    ...
    actionsHint:
      '「下载到手机」会一次性下载全部图片。「分享到应用」：先准备文件，再点分享；微信等每次约 9 张，超过会分多批，每批发完后再点「继续分享」。微信 / LINE 内请先用系统浏览器打开。',
    savePreparing: '准备中…',
    prepareProgress: '正在准备 {cur}/{total}…',
    prepareReadyShare: '准备完成，请点「分享到应用」',
    readyCountLabel: '已准备 {n} 张',
    shareToAppHint: '在系统面板中选择要分享到的 App。超过约 9 张会分多批继续。',
    sharingHint: '请在系统面板选择要分享的应用…',
    sharingBusy: '打开分享中…',
    shareBatchProgress: '正在分享第 {cur}/{total} 批…',
    continueShareBatch: '继续分享第 {cur}/{total} 批',
    shareBatchContinueHint:
      '第 {cur}/{total} 批准备就绪。请先完成上一批发送，再点按钮继续（微信等每次最多约 9 张，网页无法突破）。',
    shareAllBatchesDone: '全部分享批次已完成',
  ...
  en: {
    ...
    actionsHint:
      '“Download to phone” downloads all photos at once. “Share to app”: prepare, then share. Apps like WeChat allow about 9 photos per share — larger sets are split into batches; tap Continue after each batch. In WeChat / LINE, open in the system browser first.',
    ...
    shareToAppHint: 'Choose an app in the system share sheet. Over ~9 photos are sent in batches.',
    sharingHint: 'Choose an app in the system share sheet…',
    sharingBusy: 'Opening share…',
    shareBatchProgress: 'Sharing batch {cur}/{total}…',
    continueShareBatch: 'Continue batch {cur}/{total}',
    shareBatchContinueHint:
      'Batch {cur}/{total} is ready. Finish the previous share, then tap Continue (apps like WeChat allow about 9 photos per share; this limit cannot be bypassed).',
    shareAllBatchesDone: 'All share batches finished',
  ...
  th: {
    ...
    actionsHint:
      '「ดาวน์โหลดลงมือถือ」ดาวน์โหลดรูปทั้งหมด 「แชร์ไปแอป」: เตรียมแล้วแชร์ แอปอย่าง WeChat แชร์ได้ราว 9 รูปต่อครั้ง — เกินจะแบ่งชุด กด「แชร์ต่อ」หลังแต่ละชุด หากเปิดใน WeChat / LINE ให้เปิดด้วยเบราว์เซอร์ของเครื่องก่อน',
    ...
    shareToAppHint: 'ในแผงระบบเลือกแอป เกินประมาณ 9 รูปจะแชร์เป็นหลายชุด',
    sharingHint: 'เลือกแอปในแผงแชร์ของระบบ…',
    sharingBusy: 'กำลังเปิดแชร์…',
    shareBatchProgress: 'กำลังแชร์ชุดที่ {cur}/{total}…',
    continueShareBatch: 'แชร์ต่อชุดที่ {cur}/{total}',
    shareBatchContinueHint:
      'ชุดที่ {cur}/{total} พร้อมแล้ว ส่งชุดก่อนหน้าให้เสร็จ แล้วกดปุ่มเพื่อแชร์ต่อ (WeChat ฯลฯ จำกัดราว 9 รูปต่อครั้ง เว็บเลี่ยงไม่ได้)',
    shareAllBatchesDone: 'แชร์ครบทุกชุดแล้ว',
