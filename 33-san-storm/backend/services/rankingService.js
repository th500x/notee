...
/**
 * 道具「黄巾徽章」持有量：`players.items` JSON 中 `item_badge_season`（与 `docs/tools/event/item-template.csv`、config_items 一致）
 */
const YELLOW_TURBAN_BADGE_ITEM_ID = 'item_badge_season';
