/**
 * ESM 镜像 · 须与 characterEchoCombat.cjs 保持同步（21-1 §8.3）
 * @module shared/utils/characterEchoCombat
 */

/** 卡池重复最多写入 2 槽 */
export const POOL_ECHO_MAX = 2;

/** 卡面固定三槽（第三槽 M2 才开放写入） */
export const ECHO_SLOT_COUNT = 3;
...
export const SEASON_BADGE_ITEM_ID = 'item_badge_season';

export function parseEchoSlots(raw) {
...
export function normalizeEchoSlots(arr) {
...
export function countPoolEchoSlots(slots) {
...
export function appendPoolEchoSlot(slots, kind) {
...
export function attachEchoPctToCharacter(charData, slots) {
...
export function buildEchoState(slots) {
...
export function getEchoSlotDisplay(slot, slotIndex) {
  if (slotIndex === 2) {
