 ...
 * 须与 treasureUses.cjs 同步
 */

export const TREASURE_MAX_USES_BY_RARITY_DIGIT = {
  1: 5,
  2: 10,
  3: 15,
  4: 20,
...
export function parseTreasureIdParts(treasureId) {
...
export function getTreasureMaxUsesFromCardId(cardId) {
...
export function isPermanentTreasureCardId(cardId) {
  return getTreasureMaxUsesFromCardId(cardId) == null;
}

export function getInitialUsesRemaining(cardId) {
