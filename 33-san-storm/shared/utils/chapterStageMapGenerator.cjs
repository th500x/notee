...
const { resolveChapterDeployRects } = require('./chapterDeployPatterns.cjs');
const { parseChapterStageRoster, parseTerrainRatios } = require('./chapterStageRoster.cjs');
 ...
 * @returns {() => number}
 */
function createChapterSeededRng(seed) {
 ...
 * }}
 */
function generateChapterStageMap(stage, options = {}) {
...
module.exports = { generateChapterStageMap, createChapterSeededRng };
