 ...
 * @param {number} [seed]
 */
function createTerrainShapeRng(seed) {
 ...
 */
function createOccupancyGrid(width, height, fill = VOID) {
 ...
 */
function checkWaterConnectivity(grid) {
  const h = grid.length;
 ...
 * }}
 */
function generateTerrainOccupancy(options) {
