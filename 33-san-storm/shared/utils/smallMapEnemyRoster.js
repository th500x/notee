 ...
 * 不使用黄巾常规 `*_troop_3xxx` 池（避免与小型图 PVE 需求混淆）。关卡专用见 `*_troop_90xx`（众生）。见 `filterTroopsForSmallMapPveEnemy`。
 *
 ...
 * @see `docs/00-shared-core/00-base/03-shared-rules/03-2-ID_NAMING_GUIDE.md` §15
 */
