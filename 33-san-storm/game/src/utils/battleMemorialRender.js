...
/** public 下纪念海报目录；列表由后端 GET /api/memorial/illus-battle-list 扫 33-san-storm/public/... */
...
async function renderBattleMemorialBlob({ playerName, playerId, battle, detail }) {
  ...
  root.innerHTML = `
    ...
    <div style="position:relative;width:768px;height:1152px;overflow:hidden;">
      ...
      <div data-memorial-stage style="position:relative;box-sizing:border-box;min-height:1152px;height:100%;display:flex;flex-direction:column;padding:16px;gap:20px;">
        <div data-memorial-block="summary" style="position:relative;flex:0 0 auto;width:min(100%,420px);box-sizing:border-box;align-self:flex-end;padding:14px 16px;display:flex;flex-direction:column;gap:12px;">
        ...
        <div data-memorial-block="score" style="position:relative;flex:0 0 auto;margin-top:auto;width:min(100%,600px);box-sizing:border-box;align-self:flex-start;padding:14px 16px;display:flex;flex-direction:column;font-size:18px;line-height:1.5;">
  ...
  try {
    ...
    const blob = await captureMemorialElementToBlob(root, {
