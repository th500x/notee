 ...
 * 配色与内容区固定高度与 CommPanel（战报/传书/聊天）对齐，避免透明难读与切换跳动。
 * @see docs/01-strategic-world/10-core-system/18-4-RANKING_SYSTEM.md
...
export default function StandingRankingsPanel({ visible, playerId }) {
  ...
  }, [open, visible, playerId, loadOverall]);
          ...
          >
            <div className="flex items-center justify-between gap-1 px-2 py-2 bg-amber-800/80 shrink-0 border-b border-amber-700/30">
              <div className="flex items-center gap-1 min-w-0 flex-1 flex-wrap">
                ...
                <span className="px-2.5 py-1.5 rounded text-sm font-medium bg-amber-600 text-white shrink-0">
                  总体排名
                </span>
              </div>
              <button
