...
// 与 game 一致：静态资源直接指向仓库 `33-san-storm/public`（勿依赖 wiki/public 下符号链接；
// Linux core.symlinks=false 时链接会变成文本文件导致 ENOENT）。
// 生产构建必须把 san_1_ui_card 等打入 dist，否则 /33-san-storm/wiki/assets/ 下全部 404。
export default defineConfig({
  plugins: [react()],
  base: '/33-san-storm/wiki/',
